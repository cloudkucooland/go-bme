...
const PARANOIA_MODE_OFF paranoia_mode_t = 0
const PARANOIA_MODE_OVERLAP paranoia_mode_t = 1
const PARANOIA_MODE_SCRATCH paranoia_mode_t = 2
const PARANOIA_MODE_REPAIR paranoia_mode_t = 4
